...
/*
 * PaginatedNotificationMessageList.h
 *
 * 
 */

#ifndef PaginatedNotificationMessageList_H
#define PaginatedNotificationMessageList_H
...
class PaginatedNotificationMessageList : public Object {
public:
    PaginatedNotificationMessageList();
    PaginatedNotificationMessageList(const QString &json);
    ~PaginatedNotificationMessageList() override;
    ...
    QList<NotificationMessage> getResults() const;
    void setResults(const QList<NotificationMessage> &results);
...
private:
    ...
    QList<NotificationMessage> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedNotificationMessageList)

#endif // PaginatedNotificationMessageList_H
