...
/*
 * PaginatedReportAssetList.h
 *
 * 
 */

#ifndef PaginatedReportAssetList_H
#define PaginatedReportAssetList_H
...
public:
    ...
    QList<ReportAsset> getResults() const;
    void setResults(const QList<ReportAsset> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedReportAssetList)

#endif // PaginatedReportAssetList_H
