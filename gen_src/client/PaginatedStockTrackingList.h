...
/*
 * PaginatedStockTrackingList.h
 *
 * 
 */

#ifndef PaginatedStockTrackingList_H
#define PaginatedStockTrackingList_H
...
class PaginatedStockTrackingList : public Object {
public:
    PaginatedStockTrackingList();
    PaginatedStockTrackingList(const QString &json);
    ~PaginatedStockTrackingList() override;
    ...
    QList<StockTracking> getResults() const;
    void setResults(const QList<StockTracking> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedStockTrackingList)

#endif // PaginatedStockTrackingList_H
