...
/*
 * PaginatedReportOutputList.h
 *
 * 
 */

#ifndef PaginatedReportOutputList_H
#define PaginatedReportOutputList_H
...
class PaginatedReportOutputList : public Object {
public:
    PaginatedReportOutputList();
    PaginatedReportOutputList(QString json);
    ~PaginatedReportOutputList() override;
    ...
    QList<ReportOutput> getResults() const;
    void setResults(const QList<ReportOutput> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedReportOutputList)

#endif // PaginatedReportOutputList_H
