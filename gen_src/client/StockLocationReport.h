...
/*
 * StockLocationReport.h
 *
 * Serializer class for the StockLocationReport model
 */

#ifndef StockLocationReport_H
#define StockLocationReport_H
...
class StockLocationReport : public Object {
public:
    StockLocationReport();
    StockLocationReport(QString json);
    ~StockLocationReport() override;
...
Q_DECLARE_METATYPE(InvenTree::StockLocationReport)

#endif // StockLocationReport_H
