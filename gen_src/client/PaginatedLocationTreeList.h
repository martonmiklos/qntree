...
/*
 * PaginatedLocationTreeList.h
 *
 * 
 */

#ifndef PaginatedLocationTreeList_H
#define PaginatedLocationTreeList_H
...
class PaginatedLocationTreeList : public Object {
public:
    PaginatedLocationTreeList();
    PaginatedLocationTreeList(const QString &json);
    ~PaginatedLocationTreeList() override;
    ...
    QList<LocationTree> getResults() const;
    void setResults(const QList<LocationTree> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedLocationTreeList)

#endif // PaginatedLocationTreeList_H
