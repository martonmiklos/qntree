...
/*
 * PaginatedManufacturerPartList.h
 *
 * 
 */

#ifndef PaginatedManufacturerPartList_H
#define PaginatedManufacturerPartList_H
...
class PaginatedManufacturerPartList : public Object {
public:
    PaginatedManufacturerPartList();
    PaginatedManufacturerPartList(const QString &json);
    ~PaginatedManufacturerPartList() override;
    ...
    QList<ManufacturerPart> getResults() const;
    void setResults(const QList<ManufacturerPart> &results);
...
private:
    ...
    QList<ManufacturerPart> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedManufacturerPartList)

#endif // PaginatedManufacturerPartList_H
