...
public:
    ...
    */
    virtual void newsBulkDestroy(const BulkRequest &bulk_request);

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void newsDestroy(const qint32 &id);
    ...
    */
    virtual void newsList(const qint32 &limit, const ::InvenTree::OptionalParam<qint32> &offset = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<QString> &ordering = ::InvenTree::OptionalParam<QString>(), const ::InvenTree::OptionalParam<bool> &read = ::InvenTree::OptionalParam<bool>());
...
private:
    ...
    void newsBulkDestroyCallback(HttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void newsBulkDestroySignalFull(HttpRequestWorker *worker);
    ...
    void newsBulkDestroySignalE(QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void newsBulkDestroySignalEFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
