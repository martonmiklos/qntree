...
/*
 * NotificationUserSetting.h
 *
 * Serializer for the PluginSetting model.
 */

#ifndef NotificationUserSetting_H
#define NotificationUserSetting_H
...
class NotificationUserSetting : public Object {
public:
    NotificationUserSetting();
    NotificationUserSetting(QString json);
    ~NotificationUserSetting() override;
...
Q_DECLARE_METATYPE(InvenTree::NotificationUserSetting)

#endif // NotificationUserSetting_H
