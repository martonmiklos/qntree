...
/*
 * PatchedPluginSetting.h
 *
 * Serializer for the PluginSetting model.
 */

#ifndef PatchedPluginSetting_H
#define PatchedPluginSetting_H
...
class PatchedPluginSetting : public Object {
public:
    PatchedPluginSetting();
    PatchedPluginSetting(const QString &json);
    ~PatchedPluginSetting() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedPluginSetting)

#endif // PatchedPluginSetting_H
