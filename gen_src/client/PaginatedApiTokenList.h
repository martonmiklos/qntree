...
/*
 * PaginatedApiTokenList.h
 *
 * 
 */

#ifndef PaginatedApiTokenList_H
#define PaginatedApiTokenList_H
...
class PaginatedApiTokenList : public Object {
public:
    PaginatedApiTokenList();
    PaginatedApiTokenList(const QString &json);
    ~PaginatedApiTokenList() override;
    ...
    QList<ApiToken> getResults() const;
    void setResults(const QList<ApiToken> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedApiTokenList)

#endif // PaginatedApiTokenList_H
