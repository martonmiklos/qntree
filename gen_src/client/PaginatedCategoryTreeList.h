...
/*
 * PaginatedCategoryTreeList.h
 *
 * 
 */

#ifndef PaginatedCategoryTreeList_H
#define PaginatedCategoryTreeList_H
...
public:
    ...
    QList<CategoryTree> getResults() const;
    void setResults(const QList<CategoryTree> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedCategoryTreeList)

#endif // PaginatedCategoryTreeList_H
