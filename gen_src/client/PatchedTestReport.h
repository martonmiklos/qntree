...
#ifndef PatchedTestReport_H
#define PatchedTestReport_H
...
class PatchedTestReport : public Object {
public:
    PatchedTestReport();
    PatchedTestReport(QString json);
    ~PatchedTestReport() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedTestReport)

#endif // PatchedTestReport_H
