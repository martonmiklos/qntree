...
/*
 * PaginatedMachineConfigList.h
 *
 * 
 */

#ifndef PaginatedMachineConfigList_H
#define PaginatedMachineConfigList_H
...
public:
    ...
    QList<MachineConfig> getResults() const;
    void setResults(const QList<MachineConfig> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedMachineConfigList)

#endif // PaginatedMachineConfigList_H
