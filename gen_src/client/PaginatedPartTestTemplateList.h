...
/*
 * PaginatedPartTestTemplateList.h
 *
 * 
 */

#ifndef PaginatedPartTestTemplateList_H
#define PaginatedPartTestTemplateList_H
...
class PaginatedPartTestTemplateList : public Object {
public:
    PaginatedPartTestTemplateList();
    PaginatedPartTestTemplateList(const QString &json);
    ~PaginatedPartTestTemplateList() override;
    ...
    QList<PartTestTemplate> getResults() const;
    void setResults(const QList<PartTestTemplate> &results);
...
private:
    ...
    QList<PartTestTemplate> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPartTestTemplateList)

#endif // PaginatedPartTestTemplateList_H
