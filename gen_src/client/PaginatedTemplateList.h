...
/*
 * PaginatedTemplateList.h
 *
 * 
 */

#ifndef PaginatedTemplateList_H
#define PaginatedTemplateList_H
...
class PaginatedTemplateList : public Object {
public:
    PaginatedTemplateList();
    PaginatedTemplateList(QString json);
    ~PaginatedTemplateList() override;
    ...
    QList<Template> getResults() const;
    void setResults(const QList<Template> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedTemplateList)

#endif // PaginatedTemplateList_H
