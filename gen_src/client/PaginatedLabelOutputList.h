...
/*
 * PaginatedLabelOutputList.h
 *
 * 
 */

#ifndef PaginatedLabelOutputList_H
#define PaginatedLabelOutputList_H
...
class PaginatedLabelOutputList : public Object {
public:
    PaginatedLabelOutputList();
    PaginatedLabelOutputList(QString json);
    ~PaginatedLabelOutputList() override;
    ...
    QList<LabelOutput> getResults() const;
    void setResults(const QList<LabelOutput> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedLabelOutputList)

#endif // PaginatedLabelOutputList_H
