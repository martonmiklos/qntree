...
/*
 * ReturnOrderAttachment.h
 *
 * Serializer for the ReturnOrderAttachment model.
 */

#ifndef ReturnOrderAttachment_H
#define ReturnOrderAttachment_H
...
class ReturnOrderAttachment : public Object {
public:
    ReturnOrderAttachment();
    ReturnOrderAttachment(QString json);
    ~ReturnOrderAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::ReturnOrderAttachment)

#endif // ReturnOrderAttachment_H
