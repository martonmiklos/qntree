...
/*
 * PaginatedPendingTaskList.h
 *
 * 
 */

#ifndef PaginatedPendingTaskList_H
#define PaginatedPendingTaskList_H
...
class PaginatedPendingTaskList : public Object {
public:
    PaginatedPendingTaskList();
    PaginatedPendingTaskList(const QString &json);
    ~PaginatedPendingTaskList() override;
    ...
    QList<PendingTask> getResults() const;
    void setResults(const QList<PendingTask> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPendingTaskList)

#endif // PaginatedPendingTaskList_H
