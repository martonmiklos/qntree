...
/*
 * PaginatedGlobalSettingsList.h
 *
 * 
 */

#ifndef PaginatedGlobalSettingsList_H
#define PaginatedGlobalSettingsList_H
...
class PaginatedGlobalSettingsList : public Object {
public:
    PaginatedGlobalSettingsList();
    PaginatedGlobalSettingsList(const QString &json);
    ~PaginatedGlobalSettingsList() override;
    ...
    QList<GlobalSettings> getResults() const;
    void setResults(const QList<GlobalSettings> &results);
...
private:
    ...
    QList<GlobalSettings> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedGlobalSettingsList)

#endif // PaginatedGlobalSettingsList_H
