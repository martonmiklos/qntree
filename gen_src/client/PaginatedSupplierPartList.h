...
/*
 * PaginatedSupplierPartList.h
 *
 * 
 */

#ifndef PaginatedSupplierPartList_H
#define PaginatedSupplierPartList_H
...
public:
    ...
    QList<SupplierPart> getResults() const;
    void setResults(const QList<SupplierPart> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedSupplierPartList)

#endif // PaginatedSupplierPartList_H
