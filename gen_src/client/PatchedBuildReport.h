...
/*
 * PatchedBuildReport.h
 *
 * Serializer class for the BuildReport model
 */

#ifndef PatchedBuildReport_H
#define PatchedBuildReport_H
...
class PatchedBuildReport : public Object {
public:
    PatchedBuildReport();
    PatchedBuildReport(QString json);
    ~PatchedBuildReport() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedBuildReport)

#endif // PatchedBuildReport_H
