...
/*
 * PaginatedOwnerList.h
 *
 * 
 */

#ifndef PaginatedOwnerList_H
#define PaginatedOwnerList_H
...
class PaginatedOwnerList : public Object {
public:
    PaginatedOwnerList();
    PaginatedOwnerList(const QString &json);
    ~PaginatedOwnerList() override;
    ...
    QList<Owner> getResults() const;
    void setResults(const QList<Owner> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedOwnerList)

#endif // PaginatedOwnerList_H
