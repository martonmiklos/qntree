...
/*
 * PaginatedReportSnippetList.h
 *
 * 
 */

#ifndef PaginatedReportSnippetList_H
#define PaginatedReportSnippetList_H
...
class PaginatedReportSnippetList : public Object {
public:
    PaginatedReportSnippetList();
    PaginatedReportSnippetList(const QString &json);
    ~PaginatedReportSnippetList() override;
    ...
    QList<ReportSnippet> getResults() const;
    void setResults(const QList<ReportSnippet> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedReportSnippetList)

#endif // PaginatedReportSnippetList_H
