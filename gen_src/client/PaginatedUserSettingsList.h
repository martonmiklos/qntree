...
/*
 * PaginatedUserSettingsList.h
 *
 * 
 */

#ifndef PaginatedUserSettingsList_H
#define PaginatedUserSettingsList_H
...
public:
    ...
    QList<UserSettings> getResults() const;
    void setResults(const QList<UserSettings> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedUserSettingsList)

#endif // PaginatedUserSettingsList_H
