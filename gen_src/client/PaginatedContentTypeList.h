...
/*
 * PaginatedContentTypeList.h
 *
 * 
 */

#ifndef PaginatedContentTypeList_H
#define PaginatedContentTypeList_H
...
class PaginatedContentTypeList : public Object {
public:
    PaginatedContentTypeList();
    PaginatedContentTypeList(const QString &json);
    ~PaginatedContentTypeList() override;
    ...
    QList<ContentType> getResults() const;
    void setResults(const QList<ContentType> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedContentTypeList)

#endif // PaginatedContentTypeList_H
