...
#ifndef PaginatedPartList_H
#define PaginatedPartList_H
...
class PaginatedPartList : public Object {
public:
    PaginatedPartList();
    PaginatedPartList(const QString &json);
    ~PaginatedPartList() override;
    ...
    QList<Part> getResults() const;
    void setResults(const QList<Part> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPartList)

#endif // PaginatedPartList_H
