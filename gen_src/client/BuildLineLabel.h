...
#ifndef BuildLineLabel_H
#define BuildLineLabel_H
...
class BuildLineLabel : public Object {
public:
    BuildLineLabel();
    BuildLineLabel(QString json);
    ~BuildLineLabel() override;
...
Q_DECLARE_METATYPE(InvenTree::BuildLineLabel)

#endif // BuildLineLabel_H
