...
/*
 * PatchedCompanyAttachment.h
 *
 * Serializer for the CompanyAttachment class.
 */

#ifndef PatchedCompanyAttachment_H
#define PatchedCompanyAttachment_H
...
class PatchedCompanyAttachment : public Object {
public:
    PatchedCompanyAttachment();
    PatchedCompanyAttachment(QString json);
    ~PatchedCompanyAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedCompanyAttachment)

#endif // PatchedCompanyAttachment_H
