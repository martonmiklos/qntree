...
/*
 * PatchedPluginUserSetting.h
 *
 * Serializer for the PluginUserSetting model.
 */

#ifndef PatchedPluginUserSetting_H
#define PatchedPluginUserSetting_H
...
class PatchedPluginUserSetting : public Object {
public:
    PatchedPluginUserSetting();
    PatchedPluginUserSetting(const QString &json);
    ~PatchedPluginUserSetting() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedPluginUserSetting)

#endif // PatchedPluginUserSetting_H
