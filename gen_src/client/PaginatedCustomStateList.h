...
/*
 * PaginatedCustomStateList.h
 *
 * 
 */

#ifndef PaginatedCustomStateList_H
#define PaginatedCustomStateList_H
...
public:
    ...
    QList<CustomState> getResults() const;
    void setResults(const QList<CustomState> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedCustomStateList)

#endif // PaginatedCustomStateList_H
