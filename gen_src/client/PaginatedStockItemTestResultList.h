...
/*
 * PaginatedStockItemTestResultList.h
 *
 * 
 */

#ifndef PaginatedStockItemTestResultList_H
#define PaginatedStockItemTestResultList_H
...
class PaginatedStockItemTestResultList : public Object {
public:
    PaginatedStockItemTestResultList();
    PaginatedStockItemTestResultList(const QString &json);
    ~PaginatedStockItemTestResultList() override;
    ...
    QList<StockItemTestResult> getResults() const;
    void setResults(const QList<StockItemTestResult> &results);
...
private:
    ...
    QList<StockItemTestResult> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedStockItemTestResultList)

#endif // PaginatedStockItemTestResultList_H
