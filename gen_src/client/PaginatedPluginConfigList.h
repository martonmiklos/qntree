...
/*
 * PaginatedPluginConfigList.h
 *
 * 
 */

#ifndef PaginatedPluginConfigList_H
#define PaginatedPluginConfigList_H
...
class PaginatedPluginConfigList : public Object {
public:
    PaginatedPluginConfigList();
    PaginatedPluginConfigList(const QString &json);
    ~PaginatedPluginConfigList() override;
    ...
    QList<PluginConfig> getResults() const;
    void setResults(const QList<PluginConfig> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPluginConfigList)

#endif // PaginatedPluginConfigList_H
