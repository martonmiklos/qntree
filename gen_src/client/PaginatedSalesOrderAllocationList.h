...
/*
 * PaginatedSalesOrderAllocationList.h
 *
 * 
 */

#ifndef PaginatedSalesOrderAllocationList_H
#define PaginatedSalesOrderAllocationList_H
...
class PaginatedSalesOrderAllocationList : public Object {
public:
    PaginatedSalesOrderAllocationList();
    PaginatedSalesOrderAllocationList(const QString &json);
    ~PaginatedSalesOrderAllocationList() override;
    ...
    QList<SalesOrderAllocation> getResults() const;
    void setResults(const QList<SalesOrderAllocation> &results);
...
private:
    ...
    QList<SalesOrderAllocation> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedSalesOrderAllocationList)

#endif // PaginatedSalesOrderAllocationList_H
