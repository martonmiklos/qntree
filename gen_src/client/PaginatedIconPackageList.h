...
/*
 * PaginatedIconPackageList.h
 *
 * 
 */

#ifndef PaginatedIconPackageList_H
#define PaginatedIconPackageList_H
...
class PaginatedIconPackageList : public Object {
public:
    PaginatedIconPackageList();
    PaginatedIconPackageList(const QString &json);
    ~PaginatedIconPackageList() override;
    ...
    QList<IconPackage> getResults() const;
    void setResults(const QList<IconPackage> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedIconPackageList)

#endif // PaginatedIconPackageList_H
