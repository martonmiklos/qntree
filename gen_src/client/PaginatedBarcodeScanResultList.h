...
/*
 * PaginatedBarcodeScanResultList.h
 *
 * 
 */

#ifndef PaginatedBarcodeScanResultList_H
#define PaginatedBarcodeScanResultList_H
...
public:
    ...
    QList<BarcodeScanResult> getResults() const;
    void setResults(const QList<BarcodeScanResult> &results);
...
private:
    ...
    QList<BarcodeScanResult> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedBarcodeScanResultList)

#endif // PaginatedBarcodeScanResultList_H
