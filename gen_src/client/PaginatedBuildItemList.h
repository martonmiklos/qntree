...
/*
 * PaginatedBuildItemList.h
 *
 * 
 */

#ifndef PaginatedBuildItemList_H
#define PaginatedBuildItemList_H
...
class PaginatedBuildItemList : public Object {
public:
    PaginatedBuildItemList();
    PaginatedBuildItemList(const QString &json);
    ~PaginatedBuildItemList() override;
    ...
    QList<BuildItem> getResults() const;
    void setResults(const QList<BuildItem> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedBuildItemList)

#endif // PaginatedBuildItemList_H
