...
private:
    ...
    void buildItemDestroy2Callback(HttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void buildItemDestroy2SignalFull(HttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use buildItemDestroy2SignalError() instead")
    void buildItemDestroy2SignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void buildItemDestroy2SignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use buildItemDestroy2SignalErrorFull() instead")
    void buildItemDestroy2SignalEFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void buildItemDestroy2SignalErrorFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
