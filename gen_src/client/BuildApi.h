...
public:
    ...
    */
    ...
    /**
    * @param[in]  id qint32 [required]
    * @param[in]  build_consume BuildConsume [optional]
    */
    virtual void buildConsumeCreate(const qint32 &id, const ::InvenTree::OptionalParam<BuildConsume> &build_consume = ::InvenTree::OptionalParam<BuildConsume>());
    ...
    * @param[in]  id qint32 [required]
    */
    virtual void buildHoldCreate(const qint32 &id);

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void buildIssueCreate(const qint32 &id);

    /**
    * @param[in]  bulk_request BulkRequest [required]
    */
    virtual void buildItemBulkDestroy(const BulkRequest &bulk_request);
    ...
    * @param[in]  id qint32 [required]
    */
    virtual void buildItemDestroy(const qint32 &id);

    /**
    * @param[in]  limit qint32 [required]
    * @param[in]  build qint32 [optional]
    * @param[in]  build_detail bool [optional]
    ...
    * @param[in]  output qint32 [optional]
    * @param[in]  part qint32 [optional]
    * @param[in]  part_detail bool [optional]
    * @param[in]  search QString [optional]
    * @param[in]  stock_detail bool [optional]
    * @param[in]  stock_item qint32 [optional]
    * @param[in]  supplier_part_detail bool [optional]
    * @param[in]  tracked bool [optional]
    */
    virtual void buildItemList(const qint32 &limit, const ::InvenTree::OptionalParam<qint32> &build = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &build_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &build_line = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &include_variants = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &install_into = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<qint32> &location = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &location_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &offset = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<QString> &ordering = ::InvenTree::OptionalParam<QString>(), const ::InvenTree::OptionalParam<qint32> &output = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<qint32> &part = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &part_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<QString> &search = ::InvenTree::OptionalParam<QString>(), const ::InvenTree::OptionalParam<bool> &stock_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &stock_item = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &supplier_part_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &tracked = ::InvenTree::OptionalParam<bool>());
    ...
    * @param[in]  allocations bool [optional]
    * @param[in]  assembly bool [optional]
    * @param[in]  assembly_detail bool [optional]
    * @param[in]  available bool [optional]
    * @param[in]  bom_item qint32 [optional]
    * @param[in]  bom_item_detail bool [optional]
    * @param[in]  build qint32 [optional]
    * @param[in]  build_detail bool [optional]
    ...
    * @param[in]  tracked bool [optional]
    */
    virtual void buildLineList(const qint32 &limit, const ::InvenTree::OptionalParam<bool> &allocated = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &allocations = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &assembly = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &assembly_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &available = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &bom_item = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &bom_item_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &build = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &build_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &consumable = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &consumed = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &offset = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &on_order = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &optional = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &order_outstanding = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<QString> &ordering = ::InvenTree::OptionalParam<QString>(), const ::InvenTree::OptionalParam<qint32> &part = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &part_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<QString> &search = ::InvenTree::OptionalParam<QString>(), const ::InvenTree::OptionalParam<bool> &testable = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &tracked = ::InvenTree::OptionalParam<bool>());
    ...
    * @param[in]  part_detail bool [optional]
    */
    virtual void buildLineRetrieve(const qint32 &id, const ::InvenTree::OptionalParam<bool> &allocations = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &assembly_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &bom_item_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &build_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &part_detail = ::InvenTree::OptionalParam<bool>());
    ...
    */
    virtual void buildList(const qint32 &limit, const ::InvenTree::OptionalParam<bool> &active = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &ancestor = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<qint32> &assigned_to = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &assigned_to_me = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &category = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<QDate> &completed_after = ::InvenTree::OptionalParam<QDate>(), const ::InvenTree::OptionalParam<QDate> &completed_before = ::InvenTree::OptionalParam<QDate>(), const ::InvenTree::OptionalParam<QDate> &created_after = ::InvenTree::OptionalParam<QDate>(), const ::InvenTree::OptionalParam<QDate> &created_before = ::InvenTree::OptionalParam<QDate>(), const ::InvenTree::OptionalParam<qint32> &exclude_tree = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &external = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &has_project_code = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &has_start_date = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &has_target_date = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &include_variants = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &issued_by = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<QDate> &max_date = ::InvenTree::OptionalParam<QDate>(), const ::InvenTree::OptionalParam<QDate> &min_date = ::InvenTree::OptionalParam<QDate>(), const ::InvenTree::OptionalParam<qint32> &offset = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<QString> &ordering = ::InvenTree::OptionalParam<QString>(), const ::InvenTree::OptionalParam<bool> &outstanding = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<bool> &overdue = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &parent = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<qint32> &part = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<bool> &part_detail = ::InvenTree::OptionalParam<bool>(), const ::InvenTree::OptionalParam<qint32> &project_code = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<QString> &reference = ::InvenTree::OptionalParam<QString>(), const ::InvenTree::OptionalParam<qint32> &sales_order = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<QString> &search = ::InvenTree::OptionalParam<QString>(), const ::InvenTree::OptionalParam<QDate> &start_date_after = ::InvenTree::OptionalParam<QDate>(), const ::InvenTree::OptionalParam<QDate> &start_date_before = ::InvenTree::OptionalParam<QDate>(), const ::InvenTree::OptionalParam<qint32> &status = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<QDate> &target_date_after = ::InvenTree::OptionalParam<QDate>(), const ::InvenTree::OptionalParam<QDate> &target_date_before = ::InvenTree::OptionalParam<QDate>());
...
private:
    ...
    void buildConsumeCreateCallback(HttpRequestWorker *worker);
    ...
    void buildHoldCreateCallback(HttpRequestWorker *worker);
    void buildIssueCreateCallback(HttpRequestWorker *worker);
    void buildItemBulkDestroyCallback(HttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void buildConsumeCreateSignal(BuildConsume summary);
    void buildCreateSignal(Build summary);
    void buildCreateOutputCreateSignal(QList<StockItem> summary);
    ...
    void buildHoldCreateSignal();
    void buildIssueCreateSignal();
    void buildItemBulkDestroySignal();
    ...
    void buildStatusRetrieveSignal(GenericStateClass summary);
    ...
    void buildConsumeCreateSignalFull(HttpRequestWorker *worker, BuildConsume summary);
    void buildCreateSignalFull(HttpRequestWorker *worker, Build summary);
    void buildCreateOutputCreateSignalFull(HttpRequestWorker *worker, QList<StockItem> summary);
    ...
    void buildHoldCreateSignalFull(HttpRequestWorker *worker);
    void buildIssueCreateSignalFull(HttpRequestWorker *worker);
    void buildItemBulkDestroySignalFull(HttpRequestWorker *worker);
    ...
    void buildStatusRetrieveSignalFull(HttpRequestWorker *worker, GenericStateClass summary);
