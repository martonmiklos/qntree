...
/*
 * PatchedUserProfile.h
 *
 * Serializer for the UserProfile model.
 */

#ifndef PatchedUserProfile_H
#define PatchedUserProfile_H
...
class PatchedUserProfile : public Object {
public:
    PatchedUserProfile();
    PatchedUserProfile(const QString &json);
    ~PatchedUserProfile() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedUserProfile)

#endif // PatchedUserProfile_H
