...
/*
 * PaginatedPartLabelList.h
 *
 * 
 */

#ifndef PaginatedPartLabelList_H
#define PaginatedPartLabelList_H
...
class PaginatedPartLabelList : public Object {
public:
    PaginatedPartLabelList();
    PaginatedPartLabelList(QString json);
    ~PaginatedPartLabelList() override;
    ...
    QList<PartLabel> getResults() const;
    void setResults(const QList<PartLabel> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPartLabelList)

#endif // PaginatedPartLabelList_H
