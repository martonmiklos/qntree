...
/*
 * PaginatedCategoryList.h
 *
 * 
 */

#ifndef PaginatedCategoryList_H
#define PaginatedCategoryList_H
...
class PaginatedCategoryList : public Object {
public:
    PaginatedCategoryList();
    PaginatedCategoryList(const QString &json);
    ~PaginatedCategoryList() override;
    ...
    QList<Category> getResults() const;
    void setResults(const QList<Category> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedCategoryList)

#endif // PaginatedCategoryList_H
