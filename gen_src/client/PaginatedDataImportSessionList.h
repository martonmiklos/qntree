...
/*
 * PaginatedDataImportSessionList.h
 *
 * 
 */

#ifndef PaginatedDataImportSessionList_H
#define PaginatedDataImportSessionList_H
...
namespace InvenTree {
class DataImportSession;

class PaginatedDataImportSessionList : public Object {
public:
    PaginatedDataImportSessionList();
    PaginatedDataImportSessionList(const QString &json);
    ~PaginatedDataImportSessionList() override;
    ...
    QList<DataImportSession> getResults() const;
    void setResults(const QList<DataImportSession> &results);
...
private:
    ...
    QList<DataImportSession> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedDataImportSessionList)

#endif // PaginatedDataImportSessionList_H
