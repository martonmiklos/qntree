...
/*
 * PatchedBuildAttachment.h
 *
 * Serializer for a BuildAttachment.
 */

#ifndef PatchedBuildAttachment_H
#define PatchedBuildAttachment_H
...
class PatchedBuildAttachment : public Object {
public:
    PatchedBuildAttachment();
    PatchedBuildAttachment(QString json);
    ~PatchedBuildAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedBuildAttachment)

#endif // PatchedBuildAttachment_H
