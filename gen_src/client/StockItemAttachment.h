...
/*
 * StockItemAttachment.h
 *
 * Serializer for StockItemAttachment model.
 */

#ifndef StockItemAttachment_H
#define StockItemAttachment_H
...
class StockItemAttachment : public Object {
public:
    StockItemAttachment();
    StockItemAttachment(QString json);
    ~StockItemAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::StockItemAttachment)

#endif // StockItemAttachment_H
