...
/*
 * PatchedPartAttachment.h
 *
 * Serializer for the PartAttachment class.
 */

#ifndef PatchedPartAttachment_H
#define PatchedPartAttachment_H
...
class PatchedPartAttachment : public Object {
public:
    PatchedPartAttachment();
    PatchedPartAttachment(QString json);
    ~PatchedPartAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedPartAttachment)

#endif // PatchedPartAttachment_H
