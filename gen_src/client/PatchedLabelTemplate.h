...
/*
 * PatchedLabelTemplate.h
 *
 * Serializer class for label template model.
 */

#ifndef PatchedLabelTemplate_H
#define PatchedLabelTemplate_H
...
class PatchedLabelTemplate : public Object {
public:
    PatchedLabelTemplate();
    PatchedLabelTemplate(const QString &json);
    ~PatchedLabelTemplate() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedLabelTemplate)

#endif // PatchedLabelTemplate_H
