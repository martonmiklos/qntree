...
/*
 * PaginatedLocationList.h
 *
 * 
 */

#ifndef PaginatedLocationList_H
#define PaginatedLocationList_H
...
class PaginatedLocationList : public Object {
public:
    PaginatedLocationList();
    PaginatedLocationList(const QString &json);
    ~PaginatedLocationList() override;
    ...
    QList<Location> getResults() const;
    void setResults(const QList<Location> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedLocationList)

#endif // PaginatedLocationList_H
