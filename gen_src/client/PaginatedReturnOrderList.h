...
/*
 * PaginatedReturnOrderList.h
 *
 * 
 */

#ifndef PaginatedReturnOrderList_H
#define PaginatedReturnOrderList_H
...
public:
    ...
    QList<ReturnOrder> getResults() const;
    void setResults(const QList<ReturnOrder> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedReturnOrderList)

#endif // PaginatedReturnOrderList_H
