...
#ifndef SelectionEntry_H
#define SelectionEntry_H
...
class SelectionEntry : public Object {
public:
    SelectionEntry();
    SelectionEntry(const QString &json);
    ~SelectionEntry() override;
...
Q_DECLARE_METATYPE(InvenTree::SelectionEntry)

#endif // SelectionEntry_H
