...
/*
 * PaginatedGroupList.h
 *
 * 
 */

#ifndef PaginatedGroupList_H
#define PaginatedGroupList_H
...
class PaginatedGroupList : public Object {
public:
    PaginatedGroupList();
    PaginatedGroupList(const QString &json);
    ~PaginatedGroupList() override;
    ...
    QList<Group> getResults() const;
    void setResults(const QList<Group> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedGroupList)

#endif // PaginatedGroupList_H
