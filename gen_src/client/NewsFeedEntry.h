...
#ifndef NewsFeedEntry_H
#define NewsFeedEntry_H
...
class NewsFeedEntry : public Object {
public:
    NewsFeedEntry();
    NewsFeedEntry(const QString &json);
    ~NewsFeedEntry() override;
...
Q_DECLARE_METATYPE(InvenTree::NewsFeedEntry)

#endif // NewsFeedEntry_H
