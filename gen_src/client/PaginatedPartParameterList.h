...
/*
 * PaginatedPartParameterList.h
 *
 * 
 */

#ifndef PaginatedPartParameterList_H
#define PaginatedPartParameterList_H
...
class PaginatedPartParameterList : public Object {
public:
    PaginatedPartParameterList();
    PaginatedPartParameterList(QString json);
    ~PaginatedPartParameterList() override;
    ...
    QList<PartParameter> getResults() const;
    void setResults(const QList<PartParameter> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPartParameterList)

#endif // PaginatedPartParameterList_H
