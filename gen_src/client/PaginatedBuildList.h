...
/*
 * PaginatedBuildList.h
 *
 * 
 */

#ifndef PaginatedBuildList_H
#define PaginatedBuildList_H
...
class PaginatedBuildList : public Object {
public:
    PaginatedBuildList();
    PaginatedBuildList(const QString &json);
    ~PaginatedBuildList() override;
    ...
    QList<Build> getResults() const;
    void setResults(const QList<Build> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedBuildList)

#endif // PaginatedBuildList_H
