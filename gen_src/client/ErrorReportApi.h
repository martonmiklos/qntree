...
public:
    ...
    */
    virtual void errorReportBulkDestroy(const BulkRequest &bulk_request);

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void errorReportDestroy(const qint32 &id);
    ...
    */
    virtual void errorReportList(const qint32 &limit, const ::InvenTree::OptionalParam<qint32> &offset = ::InvenTree::OptionalParam<qint32>(), const ::InvenTree::OptionalParam<QString> &ordering = ::InvenTree::OptionalParam<QString>(), const ::InvenTree::OptionalParam<QString> &search = ::InvenTree::OptionalParam<QString>());
...
private:
    ...
    void errorReportBulkDestroyCallback(HttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void errorReportBulkDestroySignal();
    ...
    void errorReportBulkDestroySignalFull(HttpRequestWorker *worker);
    ...
    void errorReportBulkDestroySignalE(QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void errorReportBulkDestroySignalEFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
