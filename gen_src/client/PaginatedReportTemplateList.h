...
/*
 * PaginatedReportTemplateList.h
 *
 * 
 */

#ifndef PaginatedReportTemplateList_H
#define PaginatedReportTemplateList_H
...
class PaginatedReportTemplateList : public Object {
public:
    PaginatedReportTemplateList();
    PaginatedReportTemplateList(const QString &json);
    ~PaginatedReportTemplateList() override;
    ...
    QList<ReportTemplate> getResults() const;
    void setResults(const QList<ReportTemplate> &results);
...
private:
    ...
    QList<ReportTemplate> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedReportTemplateList)

#endif // PaginatedReportTemplateList_H
