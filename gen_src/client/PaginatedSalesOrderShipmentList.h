...
/*
 * PaginatedSalesOrderShipmentList.h
 *
 * 
 */

#ifndef PaginatedSalesOrderShipmentList_H
#define PaginatedSalesOrderShipmentList_H
...
class PaginatedSalesOrderShipmentList : public Object {
public:
    PaginatedSalesOrderShipmentList();
    PaginatedSalesOrderShipmentList(const QString &json);
    ~PaginatedSalesOrderShipmentList() override;
    ...
    QList<SalesOrderShipment> getResults() const;
    void setResults(const QList<SalesOrderShipment> &results);
...
private:
    ...
    QList<SalesOrderShipment> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedSalesOrderShipmentList)

#endif // PaginatedSalesOrderShipmentList_H
