...
/*
 * PaginatedCategoryParameterTemplateList.h
 *
 * 
 */

#ifndef PaginatedCategoryParameterTemplateList_H
#define PaginatedCategoryParameterTemplateList_H
...
namespace InvenTree {
class CategoryParameterTemplate;

class PaginatedCategoryParameterTemplateList : public Object {
public:
    PaginatedCategoryParameterTemplateList();
    PaginatedCategoryParameterTemplateList(const QString &json);
    ~PaginatedCategoryParameterTemplateList() override;
    ...
    QList<CategoryParameterTemplate> getResults() const;
    void setResults(const QList<CategoryParameterTemplate> &results);
...
private:
    ...
    QList<CategoryParameterTemplate> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedCategoryParameterTemplateList)

#endif // PaginatedCategoryParameterTemplateList_H
