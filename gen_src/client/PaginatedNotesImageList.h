...
/*
 * PaginatedNotesImageList.h
 *
 * 
 */

#ifndef PaginatedNotesImageList_H
#define PaginatedNotesImageList_H
...
public:
    ...
    QList<NotesImage> getResults() const;
    void setResults(const QList<NotesImage> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedNotesImageList)

#endif // PaginatedNotesImageList_H
