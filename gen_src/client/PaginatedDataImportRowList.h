...
/*
 * PaginatedDataImportRowList.h
 *
 * 
 */

#ifndef PaginatedDataImportRowList_H
#define PaginatedDataImportRowList_H
...
class PaginatedDataImportRowList : public Object {
public:
    PaginatedDataImportRowList();
    PaginatedDataImportRowList(const QString &json);
    ~PaginatedDataImportRowList() override;
    ...
    QList<DataImportRow> getResults() const;
    void setResults(const QList<DataImportRow> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedDataImportRowList)

#endif // PaginatedDataImportRowList_H
