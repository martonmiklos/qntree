...
#ifndef BuildAttachment_H
#define BuildAttachment_H
...
class BuildAttachment : public Object {
public:
    BuildAttachment();
    BuildAttachment(QString json);
    ~BuildAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::BuildAttachment)

#endif // BuildAttachment_H
