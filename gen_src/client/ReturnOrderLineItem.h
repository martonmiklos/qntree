...
/*
 * ReturnOrderLineItem.h
 *
 * Serializer for a ReturnOrderLineItem object.
 */

#ifndef ReturnOrderLineItem_H
#define ReturnOrderLineItem_H
...
class ReturnOrderLineItem : public Object {
public:
    ReturnOrderLineItem();
    ReturnOrderLineItem(const QString &json);
    ~ReturnOrderLineItem() override;
...
Q_DECLARE_METATYPE(InvenTree::ReturnOrderLineItem)

#endif // ReturnOrderLineItem_H
