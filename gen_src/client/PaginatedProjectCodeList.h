...
/*
 * PaginatedProjectCodeList.h
 *
 * 
 */

#ifndef PaginatedProjectCodeList_H
#define PaginatedProjectCodeList_H
...
class PaginatedProjectCodeList : public Object {
public:
    PaginatedProjectCodeList();
    PaginatedProjectCodeList(const QString &json);
    ~PaginatedProjectCodeList() override;
    ...
    QList<ProjectCode> getResults() const;
    void setResults(const QList<ProjectCode> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedProjectCodeList)

#endif // PaginatedProjectCodeList_H
