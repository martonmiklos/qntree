...
/*
 * PatchedSalesOrderAttachment.h
 *
 * Serializers for the SalesOrderAttachment model.
 */

#ifndef PatchedSalesOrderAttachment_H
#define PatchedSalesOrderAttachment_H
...
class PatchedSalesOrderAttachment : public Object {
public:
    PatchedSalesOrderAttachment();
    PatchedSalesOrderAttachment(QString json);
    ~PatchedSalesOrderAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedSalesOrderAttachment)

#endif // PatchedSalesOrderAttachment_H
