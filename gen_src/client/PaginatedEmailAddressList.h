...
/*
 * PaginatedEmailAddressList.h
 *
 * 
 */

#ifndef PaginatedEmailAddressList_H
#define PaginatedEmailAddressList_H
...
class PaginatedEmailAddressList : public Object {
public:
    PaginatedEmailAddressList();
    PaginatedEmailAddressList(QString json);
    ~PaginatedEmailAddressList() override;
    ...
    QList<EmailAddress> getResults() const;
    void setResults(const QList<EmailAddress> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedEmailAddressList)

#endif // PaginatedEmailAddressList_H
