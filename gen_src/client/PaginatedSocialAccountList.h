...
/*
 * PaginatedSocialAccountList.h
 *
 * 
 */

#ifndef PaginatedSocialAccountList_H
#define PaginatedSocialAccountList_H
...
class PaginatedSocialAccountList : public Object {
public:
    PaginatedSocialAccountList();
    PaginatedSocialAccountList(QString json);
    ~PaginatedSocialAccountList() override;
    ...
    QList<SocialAccount> getResults() const;
    void setResults(const QList<SocialAccount> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedSocialAccountList)

#endif // PaginatedSocialAccountList_H
