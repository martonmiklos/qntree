...
/*
 * PaginatedPartStocktakeList.h
 *
 * 
 */

#ifndef PaginatedPartStocktakeList_H
#define PaginatedPartStocktakeList_H
...
public:
    ...
    QList<PartStocktake> getResults() const;
    void setResults(const QList<PartStocktake> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPartStocktakeList)

#endif // PaginatedPartStocktakeList_H
