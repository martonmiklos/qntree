...
/*
 * PatchedUserSettings.h
 *
 * Serializer for the InvenTreeUserSetting model.
 */

#ifndef PatchedUserSettings_H
#define PatchedUserSettings_H
...
class PatchedUserSettings : public Object {
public:
    PatchedUserSettings();
    PatchedUserSettings(const QString &json);
    ~PatchedUserSettings() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedUserSettings)

#endif // PatchedUserSettings_H
