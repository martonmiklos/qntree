...
/*
 * PaginatedAttachmentList.h
 *
 * 
 */

#ifndef PaginatedAttachmentList_H
#define PaginatedAttachmentList_H
...
class PaginatedAttachmentList : public Object {
public:
    PaginatedAttachmentList();
    PaginatedAttachmentList(const QString &json);
    ~PaginatedAttachmentList() override;
    ...
    QList<Attachment> getResults() const;
    void setResults(const QList<Attachment> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedAttachmentList)

#endif // PaginatedAttachmentList_H
