...
/*
 * PatchedReturnOrderReport.h
 *
 * Serializer class for the ReturnOrderReport model
 */

#ifndef PatchedReturnOrderReport_H
#define PatchedReturnOrderReport_H
...
class PatchedReturnOrderReport : public Object {
public:
    PatchedReturnOrderReport();
    PatchedReturnOrderReport(QString json);
    ~PatchedReturnOrderReport() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedReturnOrderReport)

#endif // PatchedReturnOrderReport_H
