...
#ifndef ReturnOrderReport_H
#define ReturnOrderReport_H
...
class ReturnOrderReport : public Object {
public:
    ReturnOrderReport();
    ReturnOrderReport(QString json);
    ~ReturnOrderReport() override;
...
Q_DECLARE_METATYPE(InvenTree::ReturnOrderReport)

#endif // ReturnOrderReport_H
