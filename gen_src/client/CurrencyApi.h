...
Q_SIGNALS:
    ...
    void currencyExchangeRetrieveSignal();
    void currencyRefreshCreateSignal();

    void currencyExchangeRetrieveSignalFull(HttpRequestWorker *worker);
    ...
    void currencyExchangeRetrieveSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void currencyExchangeRetrieveSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use currencyRefreshCreateSignalError() instead")
    void currencyRefreshCreateSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void currencyExchangeRetrieveSignalEFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void currencyRefreshCreateSignalEFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
