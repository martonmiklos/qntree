...
/*
 * PatchedSalesOrderReport.h
 *
 * Serializer class for the SalesOrderReport model.
 */

#ifndef PatchedSalesOrderReport_H
#define PatchedSalesOrderReport_H
...
class PatchedSalesOrderReport : public Object {
public:
    PatchedSalesOrderReport();
    PatchedSalesOrderReport(QString json);
    ~PatchedSalesOrderReport() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedSalesOrderReport)

#endif // PatchedSalesOrderReport_H
