...
/*
 * PaginatedPurchaseOrderLineItemList.h
 *
 * 
 */

#ifndef PaginatedPurchaseOrderLineItemList_H
#define PaginatedPurchaseOrderLineItemList_H
...
public:
    ...
    QList<PurchaseOrderLineItem> getResults() const;
    void setResults(const QList<PurchaseOrderLineItem> &results);
...
private:
    ...
    QList<PurchaseOrderLineItem> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPurchaseOrderLineItemList)

#endif // PaginatedPurchaseOrderLineItemList_H
