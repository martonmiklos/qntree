...
/*
 * PaginatedPurchaseOrderExtraLineList.h
 *
 * 
 */

#ifndef PaginatedPurchaseOrderExtraLineList_H
#define PaginatedPurchaseOrderExtraLineList_H
...
namespace InvenTree {
class PurchaseOrderExtraLine;

class PaginatedPurchaseOrderExtraLineList : public Object {
public:
    PaginatedPurchaseOrderExtraLineList();
    PaginatedPurchaseOrderExtraLineList(const QString &json);
    ~PaginatedPurchaseOrderExtraLineList() override;
    ...
    QList<PurchaseOrderExtraLine> getResults() const;
    void setResults(const QList<PurchaseOrderExtraLine> &results);
...
private:
    ...
    QList<PurchaseOrderExtraLine> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPurchaseOrderExtraLineList)

#endif // PaginatedPurchaseOrderExtraLineList_H
