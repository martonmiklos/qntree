...
signals:
    ...
    void locateCreateSignal();

    void locateCreateSignalFull(HttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use locateCreateSignalError() instead")
    void locateCreateSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void locateCreateSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
