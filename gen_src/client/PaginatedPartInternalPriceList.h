...
/*
 * PaginatedPartInternalPriceList.h
 *
 * 
 */

#ifndef PaginatedPartInternalPriceList_H
#define PaginatedPartInternalPriceList_H
...
public:
    ...
    QList<PartInternalPrice> getResults() const;
    void setResults(const QList<PartInternalPrice> &results);
...
private:
    ...
    QList<PartInternalPrice> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPartInternalPriceList)

#endif // PaginatedPartInternalPriceList_H
