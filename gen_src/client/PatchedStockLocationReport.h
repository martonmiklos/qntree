...
/*
 * PatchedStockLocationReport.h
 *
 * Serializer class for the StockLocationReport model.
 */

#ifndef PatchedStockLocationReport_H
#define PatchedStockLocationReport_H
...
class PatchedStockLocationReport : public Object {
public:
    PatchedStockLocationReport();
    PatchedStockLocationReport(QString json);
    ~PatchedStockLocationReport() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedStockLocationReport)

#endif // PatchedStockLocationReport_H
