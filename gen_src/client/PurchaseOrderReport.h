...
/*
 * PurchaseOrderReport.h
 *
 * Serializer class for the PurchaseOrdeReport model
 */

#ifndef PurchaseOrderReport_H
#define PurchaseOrderReport_H
...
class PurchaseOrderReport : public Object {
public:
    PurchaseOrderReport();
    PurchaseOrderReport(QString json);
    ~PurchaseOrderReport() override;
...
Q_DECLARE_METATYPE(InvenTree::PurchaseOrderReport)

#endif // PurchaseOrderReport_H
