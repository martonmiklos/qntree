...
class IconsApi : public QObject {
    Q_OBJECT

public:
    IconsApi(const int timeOut = 0);
    ~IconsApi();
    ...
    */
    virtual void iconsList(const qint32 &limit, const ::InvenTree::OptionalParam<qint32> &offset = ::InvenTree::OptionalParam<qint32>());
...
private:
    ...
    void iconsListCallback(HttpRequestWorker *worker);

Q_SIGNALS:

    void iconsListSignal(PaginatedIconPackageList summary);
