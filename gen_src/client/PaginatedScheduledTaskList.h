...
/*
 * PaginatedScheduledTaskList.h
 *
 * 
 */

#ifndef PaginatedScheduledTaskList_H
#define PaginatedScheduledTaskList_H
...
class PaginatedScheduledTaskList : public Object {
public:
    PaginatedScheduledTaskList();
    PaginatedScheduledTaskList(const QString &json);
    ~PaginatedScheduledTaskList() override;
    ...
    QList<ScheduledTask> getResults() const;
    void setResults(const QList<ScheduledTask> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedScheduledTaskList)

#endif // PaginatedScheduledTaskList_H
