...
#ifndef DataImportRow_H
#define DataImportRow_H
...
class DataImportRow : public Object {
public:
    DataImportRow();
    DataImportRow(const QString &json);
    ~DataImportRow() override;
...
Q_DECLARE_METATYPE(InvenTree::DataImportRow)

#endif // DataImportRow_H
