...
/*
 * PaginatedAddressList.h
 *
 * 
 */

#ifndef PaginatedAddressList_H
#define PaginatedAddressList_H
...
class PaginatedAddressList : public Object {
public:
    PaginatedAddressList();
    PaginatedAddressList(const QString &json);
    ~PaginatedAddressList() override;
    ...
    QList<Address> getResults() const;
    void setResults(const QList<Address> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedAddressList)

#endif // PaginatedAddressList_H
