...
/*
 * PatchedDataImportColumnMap.h
 *
 * Serializer for the DataImportColumnMap model.
 */

#ifndef PatchedDataImportColumnMap_H
#define PatchedDataImportColumnMap_H
...
class PatchedDataImportColumnMap : public Object {
public:
    PatchedDataImportColumnMap();
    PatchedDataImportColumnMap(const QString &json);
    ~PatchedDataImportColumnMap() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedDataImportColumnMap)

#endif // PatchedDataImportColumnMap_H
