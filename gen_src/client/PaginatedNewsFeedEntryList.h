...
/*
 * PaginatedNewsFeedEntryList.h
 *
 * 
 */

#ifndef PaginatedNewsFeedEntryList_H
#define PaginatedNewsFeedEntryList_H
...
class PaginatedNewsFeedEntryList : public Object {
public:
    PaginatedNewsFeedEntryList();
    PaginatedNewsFeedEntryList(const QString &json);
    ~PaginatedNewsFeedEntryList() override;
    ...
    QList<NewsFeedEntry> getResults() const;
    void setResults(const QList<NewsFeedEntry> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedNewsFeedEntryList)

#endif // PaginatedNewsFeedEntryList_H
