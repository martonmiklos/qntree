...
/*
 * PaginatedBomItemList.h
 *
 * 
 */

#ifndef PaginatedBomItemList_H
#define PaginatedBomItemList_H
...
class PaginatedBomItemList : public Object {
public:
    PaginatedBomItemList();
    PaginatedBomItemList(const QString &json);
    ~PaginatedBomItemList() override;
    ...
    QList<BomItem> getResults() const;
    void setResults(const QList<BomItem> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedBomItemList)

#endif // PaginatedBomItemList_H
