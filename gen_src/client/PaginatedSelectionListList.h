...
/*
 * PaginatedSelectionListList.h
 *
 * 
 */

#ifndef PaginatedSelectionListList_H
#define PaginatedSelectionListList_H
...
public:
    ...
    QList<SelectionList> getResults() const;
    void setResults(const QList<SelectionList> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedSelectionListList)

#endif // PaginatedSelectionListList_H
