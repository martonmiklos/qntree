...
/*
 * PaginatedDataImportColumnMapList.h
 *
 * 
 */

#ifndef PaginatedDataImportColumnMapList_H
#define PaginatedDataImportColumnMapList_H
...
public:
    ...
    QList<DataImportColumnMap> getResults() const;
    void setResults(const QList<DataImportColumnMap> &results);
...
private:
    ...
    QList<DataImportColumnMap> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedDataImportColumnMapList)

#endif // PaginatedDataImportColumnMapList_H
