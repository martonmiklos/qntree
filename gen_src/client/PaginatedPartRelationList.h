...
/*
 * PaginatedPartRelationList.h
 *
 * 
 */

#ifndef PaginatedPartRelationList_H
#define PaginatedPartRelationList_H
...
public:
    ...
    QList<PartRelation> getResults() const;
    void setResults(const QList<PartRelation> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPartRelationList)

#endif // PaginatedPartRelationList_H
