...
/*
 * SalesOrderAttachment.h
 *
 * Serializers for the SalesOrderAttachment model.
 */

#ifndef SalesOrderAttachment_H
#define SalesOrderAttachment_H
...
class SalesOrderAttachment : public Object {
public:
    SalesOrderAttachment();
    SalesOrderAttachment(QString json);
    ~SalesOrderAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::SalesOrderAttachment)

#endif // SalesOrderAttachment_H
