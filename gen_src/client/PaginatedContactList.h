...
/*
 * PaginatedContactList.h
 *
 * 
 */

#ifndef PaginatedContactList_H
#define PaginatedContactList_H
...
class PaginatedContactList : public Object {
public:
    PaginatedContactList();
    PaginatedContactList(const QString &json);
    ~PaginatedContactList() override;
    ...
    QList<Contact> getResults() const;
    void setResults(const QList<Contact> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedContactList)

#endif // PaginatedContactList_H
