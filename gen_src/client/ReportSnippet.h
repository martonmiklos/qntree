...
#ifndef ReportSnippet_H
#define ReportSnippet_H
...
class ReportSnippet : public Object {
public:
    ReportSnippet();
    ReportSnippet(const QString &json);
    ~ReportSnippet() override;
...
Q_DECLARE_METATYPE(InvenTree::ReportSnippet)

#endif // ReportSnippet_H
