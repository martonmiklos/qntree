...
#ifndef PatchedAttachment_H
#define PatchedAttachment_H
...
class PatchedAttachment : public Object {
public:
    PatchedAttachment();
    PatchedAttachment(const QString &json);
    ~PatchedAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedAttachment)

#endif // PatchedAttachment_H
