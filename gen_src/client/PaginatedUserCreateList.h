...
/*
 * PaginatedUserCreateList.h
 *
 * 
 */

#ifndef PaginatedUserCreateList_H
#define PaginatedUserCreateList_H
...
public:
    ...
    QList<UserCreate> getResults() const;
    void setResults(const QList<UserCreate> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedUserCreateList)

#endif // PaginatedUserCreateList_H
