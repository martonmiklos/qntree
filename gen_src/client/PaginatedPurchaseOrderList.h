...
/*
 * PaginatedPurchaseOrderList.h
 *
 * 
 */

#ifndef PaginatedPurchaseOrderList_H
#define PaginatedPurchaseOrderList_H
...
class PaginatedPurchaseOrderList : public Object {
public:
    PaginatedPurchaseOrderList();
    PaginatedPurchaseOrderList(const QString &json);
    ~PaginatedPurchaseOrderList() override;
    ...
    QList<PurchaseOrder> getResults() const;
    void setResults(const QList<PurchaseOrder> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPurchaseOrderList)

#endif // PaginatedPurchaseOrderList_H
