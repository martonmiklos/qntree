...
class SupplierPriceBreakBrief : public Object {
public:
    SupplierPriceBreakBrief();
    SupplierPriceBreakBrief(const QString &json);
    ~SupplierPriceBreakBrief() override;
...
Q_DECLARE_METATYPE(InvenTree::SupplierPriceBreakBrief)

#endif // SupplierPriceBreakBrief_H
