...
#ifndef PatchedPartLabel_H
#define PatchedPartLabel_H
...
class PatchedPartLabel : public Object {
public:
    PatchedPartLabel();
    PatchedPartLabel(QString json);
    ~PatchedPartLabel() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedPartLabel)

#endif // PatchedPartLabel_H
