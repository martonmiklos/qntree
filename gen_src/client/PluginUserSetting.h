...
#ifndef PluginUserSetting_H
#define PluginUserSetting_H
...
class PluginUserSetting : public Object {
public:
    PluginUserSetting();
    PluginUserSetting(const QString &json);
    ~PluginUserSetting() override;
...
Q_DECLARE_METATYPE(InvenTree::PluginUserSetting)

#endif // PluginUserSetting_H
