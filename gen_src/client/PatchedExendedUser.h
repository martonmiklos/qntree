...
/*
 * PatchedExendedUser.h
 *
 * Serializer for a User with a bit more info.
 */

#ifndef PatchedExendedUser_H
#define PatchedExendedUser_H
...
class PatchedExendedUser : public Object {
public:
    PatchedExendedUser();
    PatchedExendedUser(QString json);
    ~PatchedExendedUser() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedExendedUser)

#endif // PatchedExendedUser_H
