...
#ifndef SalesOrderReport_H
#define SalesOrderReport_H
...
class SalesOrderReport : public Object {
public:
    SalesOrderReport();
    SalesOrderReport(QString json);
    ~SalesOrderReport() override;
...
Q_DECLARE_METATYPE(InvenTree::SalesOrderReport)

#endif // SalesOrderReport_H
