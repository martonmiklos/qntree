...
/*
 * PaginatedStockItemList.h
 *
 * 
 */

#ifndef PaginatedStockItemList_H
#define PaginatedStockItemList_H
...
class PaginatedStockItemList : public Object {
public:
    PaginatedStockItemList();
    PaginatedStockItemList(const QString &json);
    ~PaginatedStockItemList() override;
    ...
    QList<StockItem> getResults() const;
    void setResults(const QList<StockItem> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedStockItemList)

#endif // PaginatedStockItemList_H
