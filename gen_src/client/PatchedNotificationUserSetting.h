...
/*
 * PatchedNotificationUserSetting.h
 *
 * Serializer for the PluginSetting model.
 */

#ifndef PatchedNotificationUserSetting_H
#define PatchedNotificationUserSetting_H
...
class PatchedNotificationUserSetting : public Object {
public:
    PatchedNotificationUserSetting();
    PatchedNotificationUserSetting(QString json);
    ~PatchedNotificationUserSetting() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedNotificationUserSetting)

#endif // PatchedNotificationUserSetting_H
