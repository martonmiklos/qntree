...
/*
 * PaginatedEmailMessageList.h
 *
 * 
 */

#ifndef PaginatedEmailMessageList_H
#define PaginatedEmailMessageList_H
...
public:
    ...
    QList<EmailMessage> getResults() const;
    void setResults(const QList<EmailMessage> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedEmailMessageList)

#endif // PaginatedEmailMessageList_H
