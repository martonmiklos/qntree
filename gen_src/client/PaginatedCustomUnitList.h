...
/*
 * PaginatedCustomUnitList.h
 *
 * 
 */

#ifndef PaginatedCustomUnitList_H
#define PaginatedCustomUnitList_H
...
class PaginatedCustomUnitList : public Object {
public:
    PaginatedCustomUnitList();
    PaginatedCustomUnitList(const QString &json);
    ~PaginatedCustomUnitList() override;
    ...
    QList<CustomUnit> getResults() const;
    void setResults(const QList<CustomUnit> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedCustomUnitList)

#endif // PaginatedCustomUnitList_H
