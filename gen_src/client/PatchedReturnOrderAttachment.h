...
/*
 * PatchedReturnOrderAttachment.h
 *
 * Serializer for the ReturnOrderAttachment model.
 */

#ifndef PatchedReturnOrderAttachment_H
#define PatchedReturnOrderAttachment_H
...
class PatchedReturnOrderAttachment : public Object {
public:
    PatchedReturnOrderAttachment();
    PatchedReturnOrderAttachment(QString json);
    ~PatchedReturnOrderAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedReturnOrderAttachment)

#endif // PatchedReturnOrderAttachment_H
