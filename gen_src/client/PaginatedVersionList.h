...
/*
 * PaginatedVersionList.h
 *
 * 
 */

#ifndef PaginatedVersionList_H
#define PaginatedVersionList_H
...
class PaginatedVersionList : public Object {
public:
    PaginatedVersionList();
    PaginatedVersionList(QString json);
    ~PaginatedVersionList() override;
    ...
    QList<Version> getResults() const;
    void setResults(const QList<Version> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedVersionList)

#endif // PaginatedVersionList_H
