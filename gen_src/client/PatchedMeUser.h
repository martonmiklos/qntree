...
#ifndef PatchedMeUser_H
#define PatchedMeUser_H
...
class PatchedMeUser : public Object {
public:
    PatchedMeUser();
    PatchedMeUser(const QString &json);
    ~PatchedMeUser() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedMeUser)

#endif // PatchedMeUser_H
