...
/*
 * PaginatedBomItemSubstituteList.h
 *
 * 
 */

#ifndef PaginatedBomItemSubstituteList_H
#define PaginatedBomItemSubstituteList_H
...
public:
    ...
    QList<BomItemSubstitute> getResults() const;
    void setResults(const QList<BomItemSubstitute> &results);
...
private:
    ...
    QList<BomItemSubstitute> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedBomItemSubstituteList)

#endif // PaginatedBomItemSubstituteList_H
