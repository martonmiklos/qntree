...
/*
 * PaginatedSalesOrderExtraLineList.h
 *
 * 
 */

#ifndef PaginatedSalesOrderExtraLineList_H
#define PaginatedSalesOrderExtraLineList_H
...
namespace InvenTree {
class SalesOrderExtraLine;

class PaginatedSalesOrderExtraLineList : public Object {
public:
    PaginatedSalesOrderExtraLineList();
    PaginatedSalesOrderExtraLineList(const QString &json);
    ~PaginatedSalesOrderExtraLineList() override;
    ...
    QList<SalesOrderExtraLine> getResults() const;
    void setResults(const QList<SalesOrderExtraLine> &results);
...
private:
    ...
    QList<SalesOrderExtraLine> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedSalesOrderExtraLineList)

#endif // PaginatedSalesOrderExtraLineList_H
