...
/*
 * PatchedPurchaseOrderAttachment.h
 *
 * Serializers for the PurchaseOrderAttachment model.
 */

#ifndef PatchedPurchaseOrderAttachment_H
#define PatchedPurchaseOrderAttachment_H
...
class PatchedPurchaseOrderAttachment : public Object {
public:
    PatchedPurchaseOrderAttachment();
    PatchedPurchaseOrderAttachment(QString json);
    ~PatchedPurchaseOrderAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedPurchaseOrderAttachment)

#endif // PatchedPurchaseOrderAttachment_H
