...
/*
 * PaginatedBuildReportList.h
 *
 * 
 */

#ifndef PaginatedBuildReportList_H
#define PaginatedBuildReportList_H
...
class PaginatedBuildReportList : public Object {
public:
    PaginatedBuildReportList();
    PaginatedBuildReportList(QString json);
    ~PaginatedBuildReportList() override;
    ...
    QList<BuildReport> getResults() const;
    void setResults(const QList<BuildReport> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedBuildReportList)

#endif // PaginatedBuildReportList_H
