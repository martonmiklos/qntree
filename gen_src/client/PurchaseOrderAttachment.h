...
/*
 * PurchaseOrderAttachment.h
 *
 * Serializers for the PurchaseOrderAttachment model.
 */

#ifndef PurchaseOrderAttachment_H
#define PurchaseOrderAttachment_H
...
class PurchaseOrderAttachment : public Object {
public:
    PurchaseOrderAttachment();
    PurchaseOrderAttachment(QString json);
    ~PurchaseOrderAttachment() override;
...
Q_DECLARE_METATYPE(InvenTree::PurchaseOrderAttachment)

#endif // PurchaseOrderAttachment_H
