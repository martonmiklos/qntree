...
/*
 * PaginatedLabelTemplateList.h
 *
 * 
 */

#ifndef PaginatedLabelTemplateList_H
#define PaginatedLabelTemplateList_H
...
class PaginatedLabelTemplateList : public Object {
public:
    PaginatedLabelTemplateList();
    PaginatedLabelTemplateList(const QString &json);
    ~PaginatedLabelTemplateList() override;
    ...
    QList<LabelTemplate> getResults() const;
    void setResults(const QList<LabelTemplate> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedLabelTemplateList)

#endif // PaginatedLabelTemplateList_H
