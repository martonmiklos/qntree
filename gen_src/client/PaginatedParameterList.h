...
/*
 * PaginatedParameterList.h
 *
 * 
 */

#ifndef PaginatedParameterList_H
#define PaginatedParameterList_H
...
class PaginatedParameterList : public Object {
public:
    PaginatedParameterList();
    PaginatedParameterList(const QString &json);
    ~PaginatedParameterList() override;
    ...
    QList<Parameter> getResults() const;
    void setResults(const QList<Parameter> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedParameterList)

#endif // PaginatedParameterList_H
