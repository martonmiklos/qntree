...
/*
 * PaginatedRuleSetList.h
 *
 * 
 */

#ifndef PaginatedRuleSetList_H
#define PaginatedRuleSetList_H
...
public:
    ...
    QList<RuleSet> getResults() const;
    void setResults(const QList<RuleSet> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedRuleSetList)

#endif // PaginatedRuleSetList_H
