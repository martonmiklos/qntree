...
#ifndef PatchedContact_H
#define PatchedContact_H
...
class PatchedContact : public Object {
public:
    PatchedContact();
    PatchedContact(const QString &json);
    ~PatchedContact() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedContact)

#endif // PatchedContact_H
