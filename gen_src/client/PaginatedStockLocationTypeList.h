...
/*
 * PaginatedStockLocationTypeList.h
 *
 * 
 */

#ifndef PaginatedStockLocationTypeList_H
#define PaginatedStockLocationTypeList_H
...
public:
    ...
    QList<StockLocationType> getResults() const;
    void setResults(const QList<StockLocationType> &results);
...
private:
    ...
    QList<StockLocationType> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedStockLocationTypeList)

#endif // PaginatedStockLocationTypeList_H
