...
/*
 * PaginatedParameterTemplateList.h
 *
 * 
 */

#ifndef PaginatedParameterTemplateList_H
#define PaginatedParameterTemplateList_H
...
class PaginatedParameterTemplateList : public Object {
public:
    PaginatedParameterTemplateList();
    PaginatedParameterTemplateList(const QString &json);
    ~PaginatedParameterTemplateList() override;
    ...
    QList<ParameterTemplate> getResults() const;
    void setResults(const QList<ParameterTemplate> &results);
...
private:
    ...
    QList<ParameterTemplate> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedParameterTemplateList)

#endif // PaginatedParameterTemplateList_H
