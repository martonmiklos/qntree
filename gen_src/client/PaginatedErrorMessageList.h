...
/*
 * PaginatedErrorMessageList.h
 *
 * 
 */

#ifndef PaginatedErrorMessageList_H
#define PaginatedErrorMessageList_H
...
class PaginatedErrorMessageList : public Object {
public:
    PaginatedErrorMessageList();
    PaginatedErrorMessageList(const QString &json);
    ~PaginatedErrorMessageList() override;
    ...
    QList<ErrorMessage> getResults() const;
    void setResults(const QList<ErrorMessage> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedErrorMessageList)

#endif // PaginatedErrorMessageList_H
