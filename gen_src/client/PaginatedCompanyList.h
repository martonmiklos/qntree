...
/*
 * PaginatedCompanyList.h
 *
 * 
 */

#ifndef PaginatedCompanyList_H
#define PaginatedCompanyList_H
...
public:
    ...
    QList<Company> getResults() const;
    void setResults(const QList<Company> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedCompanyList)

#endif // PaginatedCompanyList_H
