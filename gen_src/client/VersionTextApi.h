...
Q_SIGNALS:
    ...
    void versionTextListSignalE(PaginatedVersionInformationList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void versionTextListSignalError(PaginatedVersionInformationList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
