...
/*
 * PaginatedReturnOrderExtraLineList.h
 *
 * 
 */

#ifndef PaginatedReturnOrderExtraLineList_H
#define PaginatedReturnOrderExtraLineList_H
...
class PaginatedReturnOrderExtraLineList : public Object {
public:
    PaginatedReturnOrderExtraLineList();
    PaginatedReturnOrderExtraLineList(const QString &json);
    ~PaginatedReturnOrderExtraLineList() override;
    ...
    QList<ReturnOrderExtraLine> getResults() const;
    void setResults(const QList<ReturnOrderExtraLine> &results);
...
private:
    ...
    QList<ReturnOrderExtraLine> m_results;
...
Q_DECLARE_METATYPE(InvenTree::PaginatedReturnOrderExtraLineList)

#endif // PaginatedReturnOrderExtraLineList_H
