...
/*
 * PaginatedTestReportList.h
 *
 * 
 */

#ifndef PaginatedTestReportList_H
#define PaginatedTestReportList_H
...
class PaginatedTestReportList : public Object {
public:
    PaginatedTestReportList();
    PaginatedTestReportList(QString json);
    ~PaginatedTestReportList() override;
    ...
    QList<TestReport> getResults() const;
    void setResults(const QList<TestReport> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedTestReportList)

#endif // PaginatedTestReportList_H
