...
/*
 * PaginatedPartThumbList.h
 *
 * 
 */

#ifndef PaginatedPartThumbList_H
#define PaginatedPartThumbList_H
...
public:
    ...
    QList<PartThumb> getResults() const;
    void setResults(const QList<PartThumb> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedPartThumbList)

#endif // PaginatedPartThumbList_H
