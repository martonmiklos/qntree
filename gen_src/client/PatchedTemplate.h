...
#ifndef PatchedTemplate_H
#define PatchedTemplate_H
...
class PatchedTemplate : public Object {
public:
    PatchedTemplate();
    PatchedTemplate(QString json);
    ~PatchedTemplate() override;
...
Q_DECLARE_METATYPE(InvenTree::PatchedTemplate)

#endif // PatchedTemplate_H
