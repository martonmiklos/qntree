...
/*
 * PaginatedDataOutputList.h
 *
 * 
 */

#ifndef PaginatedDataOutputList_H
#define PaginatedDataOutputList_H
...
class PaginatedDataOutputList : public Object {
public:
    PaginatedDataOutputList();
    PaginatedDataOutputList(const QString &json);
    ~PaginatedDataOutputList() override;
    ...
    QList<DataOutput> getResults() const;
    void setResults(const QList<DataOutput> &results);
...
Q_DECLARE_METATYPE(InvenTree::PaginatedDataOutputList)

#endif // PaginatedDataOutputList_H
